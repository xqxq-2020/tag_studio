...
class ViewBaseModel(models.Model):
    data = models.JSONField(_("data"), default=dict, null=True, help_text="自定义视图数据")
    ordering = models.JSONField(_("ordering"), default=dict, null=True, help_text="排序参数")
    selected_items = models.JSONField(_("selected items"), default=dict, null=True, help_text="所选项目")
    filter_group = models.ForeignKey(
        "data_manager.FilterGroup", null=True, on_delete=models.SET_NULL, help_text="过滤器组"
    )
